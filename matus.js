const gruasMatus = {
    ...
    HAWAII: [{ ciudad: "A Cotizar", precio: 0 },
        { ciudad: "Honolulu (Copart/IAAI)", precio: 0 }],
    IDAHO: [
        { ciudad: "A Cotizar", precio: 0 },
        { ciudad: "Boise (Copart/IAAI)", precio: 775 }
    ],
    MONTANA: [
        { ciudad: "A Cotizar", precio: 0 },
    ...
    NEW_MEXICO: [
        { ciudad: "A Cotizar", precio: 0 },
        { ciudad: "Albuquerque (Copart/IAAI)", precio: 795 }
    ],
    OREGON: [
        { ciudad: "A Cotizar", precio: 0 },
